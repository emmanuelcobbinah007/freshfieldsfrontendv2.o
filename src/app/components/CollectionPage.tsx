...
const productCategories: { [key: string]: Category } = {
  ...
  "2": {
    ...
    fullDescription:
      "Our fresh fish is caught daily and delivered to ensure maximum freshness. The fish is wild-caught and free from preservatives, making it a healthy choice for your meals. Rich in Omega-3 fatty acids, our fish is not only delicious but also beneficial for your health.",
    price: 20.0,
    image: fishImg,
  ...
  "4": {
    ...
    fullDescription:
      "Our fresh herbs are picked daily to ensure maximum freshness and flavor. They are organic and free from pesticides, making them a healthy addition to your meals. Use our herbs to enhance the flavor of your dishes and add a touch of freshness to your cooking.",
    price: 6.0,
    image: herbImg,
  ...
  "5": {
    ...
    fullDescription:
      "Our fresh legumes are sourced from local farms that follow sustainable farming practices. They are organic, high in protein, and free from preservatives. Legumes are a great source of nutrition and can be used in a variety of dishes to add flavor and texture.",
    price: 10.0,
    image: legumeImg,
  ...
  "6": {
    ...
    fullDescription:
      "Our cooking oil is cold-pressed and free from additives, making it a healthy choice for your cooking needs. It is rich in nutrients and has a high smoke point, making it perfect for frying, sautéing, and baking. Use our cooking oil to enhance the flavor of your dishes and promote a healthy lifestyle.",
    price: 30.0,
    image: oilImg,
  ...
  "7": {
    ...
    fullDescription:
      "Our fresh tubers are sourced from local farms that practice sustainable farming. They are organic, rich in fiber, and free from pesticides. Tubers are a great source of nutrition and can be used in a variety of dishes to add flavor and texture.",
    price: 12.0,
    image: tuberImg,
  ...
  "8": {
    ...
    fullDescription:
      "Our fresh vegetables are picked daily to ensure maximum freshness and flavor. They are organic and free from pesticides, making them a healthy addition to your meals. Use our vegetables to add flavor and nutrition to your dishes and promote a healthy lifestyle.",
    price: 10.0,
    image: veggiesImg,
    features: ["Organic", "Freshly picked", "No pesticides"],
    reviews: [
...
const CollectionPage = () => {
  ...
  return (
    <div className="w-[90%] md:w-[80%] mx-auto pt-10">
      <h1 className="font-semibold text-lg sm:text-2xl md:text-3xl px-4 text-center">
        {category.name}
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 py-4">
        {Array.from({ length: 9 }).map((_, index) => (
          <div
            key={index}
            className="flex flex-col items-center transform transition-transform duration-300 hover:scale-105 hover:shadow-lg rounded-lg p-4 bg-white"
          >
            <Link href={`/product/${category.id}`} passHref>
              <Image
                src={category.image.src}
                className="w-[75%] rounded-t-lg cursor-pointer z-0"
                alt={category.name}
