    ...
    <div className='w-[90%] mx-auto'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 py-8'>
            <div className='flex flex-col items-center p-2'>
                <img src={(container as StaticImageData).src} className='w-[40%] md:w-[25%]' alt='quality' />
            ...
            <div className='flex flex-col items-center p-2'>
                <img src={(customerSupport as StaticImageData).src} className='w-[40%] md:w-[25%]' alt='organic' />
            ...
            <div className='flex flex-col items-center p-2'>
                <img src={(securePayment as StaticImageData).src} className='w-[40%] md:w-[25%]' alt='eco-friendly' />
            ...
            <div className='flex flex-col items-center p-2'>
                <img src={(moneyBack as StaticImageData).src} className='w-[40%] md:w-[25%]' alt='money-back' />
