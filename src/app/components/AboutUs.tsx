...
const AboutUs = () => {
  return (
    <div className='w-[90%] md:w-[80%] mx-auto md:pt-10'>
      ...
      <div className='mt-10'>
        <h1 className='text-2xl md:text-3xl font-bold text-center mb-6 text-[#489706]'>About The Store</h1>
      ...
      <div className='mt-10'>
        <h1 className='text-2xl md:text-3xl font-bold text-center mb-6 text-[#489706]'>Why Choose Us?</h1>
        <p className='text-base md:text-lg text-center leading-relaxed text-gray-700'>
      ...
      <div className='mt-10'>
        <h1 className='text-2xl md:text-3xl font-bold text-center mb-6 text-[#489706]'>Our Mission</h1>
        <p className='text-base md:text-lg text-center leading-relaxed text-gray-700'>
      ...
      <div className='mt-10'>
        <h1 className='text-2xl md:text-3xl font-bold text-center mb-6 text-[#489706]'>Contact Us</h1>
        <p className='text-base md:text-lg text-center leading-relaxed text-gray-700'>
      ...
      <div className='mt-10'>
        <h1 className='text-2xl md:text-3xl font-bold text-center mb-6 text-[#489706]'>Our Values</h1>
