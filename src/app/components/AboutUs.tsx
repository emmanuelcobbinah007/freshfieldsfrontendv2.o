    ...
    <div className="w-[90%] md:w-[80%] mx-auto md:pt-10">
      <div className="hidden md:flex justify-center md:justify-center">
        <Image
          ...
          className="w-[70%] md:w-[55%] mx-auto"
          alt="logo"
      ...
      <div className="mt-10">
        <h1 className="text-2xl md:text-3xl font-bold text-center mb-6 text-[#489706] font-playfair">
          About The Store
        </h1>
        <p className="text-base md:text-lg text-center leading-relaxed text-gray-700">
          ...
          vegetables, and groceries and get them delivered to you at the comfort
      ...
      <div className="mt-10">
        ...
        <p className="text-base md:text-lg text-center leading-relaxed text-gray-700">
          ...
          the supply of fresh, quality, and healthy foodstuffs to our customers.
          Also, our e-payment system and cash-on-delivery options provide
      ...
      <div className="mt-10">
        ...
        <p className="text-base md:text-lg text-center leading-relaxed text-gray-700">
          Our mission is to provide fresh, healthy, and affordable food to
          everyone. We strive to support local farmers and promote sustainable
          farming practices.
        </p>
      </div>
      ...
      <div className="mt-10">
        ...
        <p className="text-base md:text-lg text-center leading-relaxed text-gray-700">
          ...
          <a
            href="mailto:info@freshfields.com"
            className="text-[#489706] underline"
          >
            info@freshfields.com
          </a>
          .
        </p>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full md:w-1/3">
            <p className="text-base md:text-lg text-gray-700">
              &quot;Fresh Fields has the best quality products. I am very
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full md:w-1/3">
            <p className="text-base md:text-lg text-gray-700">
              &quot;I love the freshness of the products. Highly recommend Fresh
              Fields!&quot;
            </p>
