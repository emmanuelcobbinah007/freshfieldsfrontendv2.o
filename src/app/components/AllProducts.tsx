...
const AllProducts = () => {
  const products = [
    { id: '1', name: 'Fresh Meat', price: 24.00, image: meatImg },
    { id: '2', name: 'Fresh Fish', price: 20.00, image: fishImg },
    { id: '3', name: 'Fresh Fruits', price: 15.00, image: fruitImg },
    { id: '4', name: 'Fresh Herbs', price: 6.00, image: herbImg },
    { id: '5', name: 'Fresh Legumes', price: 10.00, image: legumeImg },
    { id: '6', name: 'Cooking Oil', price: 30.00, image: oilImg },
    { id: '7', name: 'Fresh Tubers', price: 12.00, image: tuberImg },
    { id: '8', name: 'Fresh Veggies', price: 10.00, image: veggiesImg },
  ];
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 py-4'>
          {products.map((product) => (
            <div key={product.id} className='flex flex-col items-center px-3 hover:cursor-pointer hover:shadow-lg duration-300 rounded-lg hover:scale-105'>
              ...
              <p className='text-center mt-2'>High-quality fresh {product.name.toLowerCase()} sourced from local farms.</p>
